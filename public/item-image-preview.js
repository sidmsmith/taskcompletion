 ...
 * Ported verbatim from receivingworkbench's public/item-image-preview.js
 * (2026-08-10) — see taskcompletion's CLAUDE.md for why this app wires
 * it up generically instead of per-table.
 */
(function () {
  ...
  function ensurePreviewElement() {
    ...
    previewEl.addEventListener("mouseleave", (e) => {
      ...
      if (related && related.closest && related.closest(".item-image-wrap")) return;
      scheduleHidePreview();
    });
  ...
  function positionPreview(anchor) {
    ...
    const url = anchor.dataset.imageUrl || (anchor.querySelector("img") && anchor.querySelector("img").src) || "";
    if (!url) return;
    img.src = url;
